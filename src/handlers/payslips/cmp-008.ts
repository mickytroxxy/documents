...
const COLORS = {
    primary: rgb(0.2, 0.6, 0.9), // Sky blue
    secondary: rgb(0.4, 0.8, 1), // Light sky blue
    accent: rgb(1, 0.8, 0), // Gold
    background: rgb(0.9, 0.95, 1), // Very light blue background
    text: rgb(0, 0, 0),
    positive: rgb(0, 0.5, 0), // Green
    negative: rgb(0.8, 0, 0), // Red
    border: rgb(0.6, 0.8, 0.9), // Light blue
    white: rgb(1, 1, 1),
    lightAccent: rgb(0.95, 0.98, 1) // Very light blue for backgrounds
};

export const generatePayslip8PDF = async (payslip: PayslipData, index: number, outputDir?: string): Promise<string> => {
