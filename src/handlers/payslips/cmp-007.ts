...
const COLORS = {
    primary: rgb(1, 0.5, 0), // Orange
    secondary: rgb(1, 0.7, 0.2), // Light orange
    accent: rgb(1, 0.8, 0), // Gold
    background: rgb(1, 0.95, 0.9), // Light orange background
    text: rgb(0, 0, 0),
    positive: rgb(0, 0.5, 0), // Green
    negative: rgb(0.8, 0, 0), // Red
    border: rgb(0.8, 0.6, 0.4), // Light orange
    white: rgb(1, 1, 1),
    lightAccent: rgb(1, 0.97, 0.9) // Very light orange for backgrounds
};

export const generatePayslip7PDF = async (payslip: PayslipData, index: number, outputDir?: string): Promise<string> => {
