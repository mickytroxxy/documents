...
const COLORS = {
    primary: rgb(0.2, 0, 0.4), // Purple
    secondary: rgb(0.5, 0.2, 0.8), // Light purple
    accent: rgb(1, 0.8, 0), // Gold
    background: rgb(0.95, 0.95, 0.98), // Very light purple background
    text: rgb(0, 0, 0),
    positive: rgb(0, 0.5, 0), // Green
    negative: rgb(0.8, 0, 0), // Red
    border: rgb(0.6, 0.6, 0.6), // Gray
    white: rgb(1, 1, 1),
    lightAccent: rgb(0.9, 0.9, 1) // Very light purple for backgrounds
};

export const generatePayslip2PDF = async (payslip: PayslipData, index: number, outputDir?: string): Promise<string> => {
