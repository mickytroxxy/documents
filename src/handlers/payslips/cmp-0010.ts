...
const COLORS = {
    primary: rgb(0.8, 0, 0), // Red
    secondary: rgb(1, 0.2, 0.2), // Light red
    accent: rgb(1, 0.8, 0), // Gold
    background: rgb(1, 0.95, 0.95), // Light red background
    text: rgb(0, 0, 0),
    positive: rgb(0, 0.5, 0), // Green
    negative: rgb(0.8, 0, 0), // Red
    border: rgb(0.9, 0.6, 0.6), // Light red
    white: rgb(1, 1, 1),
    lightAccent: rgb(1, 0.97, 0.97) // Very light red for backgrounds
};

export const generatePayslip10PDF = async (payslip: PayslipData, index: number, outputDir?: string): Promise<string> => {
